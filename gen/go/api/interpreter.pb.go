...
type CompiledPlan struct {
	...
	SpuRuntimeConf *libspu.RuntimeConfig `protobuf:"bytes,3,opt,name=spu_runtime_conf,json=spuRuntimeConf,proto3" json:"spu_runtime_conf,omitempty"`
	...
	SubGraphs map[string]*SubGraph `protobuf:"bytes,5,rep,name=sub_graphs,json=subGraphs,proto3" json:"sub_graphs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // TODO: Add field to specify the party who report final query result.
...
func (x *CompiledPlan) GetSpuRuntimeConf() *libspu.RuntimeConfig {
	if x != nil {
...
type CompileOptions struct {
	...
	SpuConf            *libspu.RuntimeConfig     `protobuf:"bytes,1,opt,name=spu_conf,json=spuConf,proto3" json:"spu_conf,omitempty"`
...
func (x *CompileOptions) GetSpuConf() *libspu.RuntimeConfig {
	if x != nil {
		return x.SpuConf
	}
	return nil
...
var file_api_interpreter_proto_rawDesc = []byte{
	...
	0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x83,
	0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x42, 0x10,
	...
	0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0xa2, 0x02, 0x03, 0x53, 0x50, 0x58, 0xaa,
	0x02, 0x07, 0x53, 0x63, 0x71, 0x6c, 0x2e, 0x50, 0x62, 0xca, 0x02, 0x07, 0x53, 0x63, 0x71, 0x6c,
	0x5c, 0x50, 0x62, 0xe2, 0x02, 0x13, 0x53, 0x63, 0x71, 0x6c, 0x5c, 0x50, 0x62, 0x5c, 0x47, 0x50,
	0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x08, 0x53, 0x63, 0x71, 0x6c,
	0x3a, 0x3a, 0x50, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_interpreter_proto_goTypes = []interface{}{
	...
	(*libspu.RuntimeConfig)(nil),     // 16: spu.RuntimeConfig
