...
import (
	...
	_ "github.com/secretflow/scql/gen/go/libspu"
...
func (x *AuditBody) GetCclDetail() *api.SecurityConfig {
...
type AuditBody_CclDetail struct {
	CclDetail *api.SecurityConfig `protobuf:"bytes,9,opt,name=ccl_detail,json=cclDetail,proto3,oneof"`
}
...
type RunAsyncQueryEvent struct {
	...
	Query    string    `protobuf:"bytes,4,opt,name=query,proto3" json:"query,omitempty"`
	Type     QueryType `protobuf:"varint,5,opt,name=type,proto3,enum=audit.pb.QueryType" json:"type,omitempty"`
	CostTime int64     `protobuf:"varint,6,opt,name=cost_time,json=costTime,proto3" json:"cost_time,omitempty"` // unit: ms
}
...
type SessionParameters struct {
	...
	Parameters *api.SessionStartParams `protobuf:"bytes,2,opt,name=parameters,proto3" json:"parameters,omitempty"`
}
...
func (x *SessionParameters) GetParameters() *api.SessionStartParams {
	if x != nil {
		return x.Parameters
	}
	return nil
...
var file_pkg_audit_audit_proto_rawDesc = []byte{
	...
	,
...
var file_pkg_audit_audit_proto_goTypes = []interface{}{
	...
	(*api.SecurityConfig)(nil),     // 12: scql.pb.SecurityConfig
