...
type AuditHeader struct {
	...
	Status    *api.Status            `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
...
func (x *AuditHeader) GetStatus() *api.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_pkg_audit_common_proto_rawDesc = []byte{
	...
	,
...
var file_pkg_audit_common_proto_goTypes = []interface{}{
	...
	(*api.Status)(nil),            // 8: scql.pb.Status
}
